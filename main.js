...
//timing_response: 10000,
    timeline: [
        ...
        {stimuli: [`${repoSite}ImageFiles/blue-test.png`, `${repoSite}ImageFiles/orange-test.png`], answer: 'same'},
        ...
        // {stimuli: [`${repoSite}ImageFiles/word-single3.bmp`, `${repoSite}ImageFiles/word-two3.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/single4.bmp`, `${repoSite}ImageFiles/two4.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/word-single4.bmp`, `${repoSite}ImageFiles/word-two4.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/single5.bmp`, `${repoSite}ImageFiles/two5.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/word-single5.bmp`, `${repoSite}ImageFiles/word-two5.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/single6.bmp`, `${repoSite}ImageFiles/two6.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single6.bmp`, `${repoSite}ImageFiles/word-two6.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/single7.bmp`, `${repoSite}ImageFiles/two7.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single7.bmp`, `${repoSite}ImageFiles/word-two7.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/single8.bmp`, `${repoSite}ImageFiles/two8.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single8.bmp`, `${repoSite}ImageFiles/word-two8.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/single9.bmp`, `${repoSite}ImageFiles/two9.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single9.bmp`, `${repoSite}ImageFiles/word-two9.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/single10.bmp`, `${repoSite}ImageFiles/two10.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single10.bmp`, `${repoSite}ImageFiles/word-two10.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/single11.bmp`, `${repoSite}ImageFiles/two11.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/word-single11.bmp`, `${repoSite}ImageFiles/word-two11.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/single12.bmp`, `${repoSite}ImageFiles/two12.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/word-single12.bmp`, `${repoSite}ImageFiles/word-two12.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/single13.bmp`, `${repoSite}ImageFiles/two13.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/word-single13.bmp`, `${repoSite}ImageFiles/word-two13.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/single14.bmp`, `${repoSite}ImageFiles/two14.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/word-single14.bmp`, `${repoSite}ImageFiles/word-two14.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/single15.bmp`, `${repoSite}ImageFiles/two15.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/word-single15.bmp`, `${repoSite}ImageFiles/word-two15.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/single16.bmp`, `${repoSite}ImageFiles/two16.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single16.bmp`, `${repoSite}ImageFiles/word-two16.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/single17.bmp`, `${repoSite}ImageFiles/two17.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single17.bmp`, `${repoSite}ImageFiles/word-two17.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/single18.bmp`, `${repoSite}ImageFiles/two18.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single18.bmp`, `${repoSite}ImageFiles/word-two18.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/single19.bmp`, `${repoSite}ImageFiles/two19.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single19.bmp`, `${repoSite}ImageFiles/word-two19.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/single20.bmp`, `${repoSite}ImageFiles/two20.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single20.bmp`, `${repoSite}ImageFiles/word-two20.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/single21.bmp`, `${repoSite}ImageFiles/two21.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/word-single21.bmp`, `${repoSite}ImageFiles/word-two21.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/single22.bmp`, `${repoSite}ImageFiles/two22.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/word-single22.bmp`, `${repoSite}ImageFiles/word-two22.bmp`], answer: 'same'},
        // {stimuli: [`${repoSite}ImageFiles/single23.bmp`, `${repoSite}ImageFiles/two23.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single23.bmp`, `${repoSite}ImageFiles/word-two23.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/single24.bmp`, `${repoSite}ImageFiles/two24.bmp`], answer: 'different'},
        // {stimuli: [`${repoSite}ImageFiles/word-single24.bmp`, `${repoSite}ImageFiles/word-two24.bmp`], answer: 'different'},
    ],
...
var images = [`${repoSite}ImageFiles/two1.bmp`, `${repoSite}ImageFiles/two2.bmp`, `${repoSite}ImageFiles/two3.bmp`, `${repoSite}ImageFiles/two4.bmp`, `${repoSite}ImageFiles/two5.bmp`, `${repoSite}ImageFiles/two6.bmp`, `${repoSite}ImageFiles/two7.bmp`, `${repoSite}ImageFiles/two8.bmp`, `${repoSite}ImageFiles/two9.bmp`, `${repoSite}ImageFiles/two10.bmp`, `${repoSite}ImageFiles/two11.bmp`, `${repoSite}ImageFiles/two12.bmp`, `${repoSite}ImageFiles/two13.bmp`, `${repoSite}ImageFiles/two14.bmp`, `${repoSite}ImageFiles/two15.bmp`, `${repoSite}ImageFiles/two16.bmp`, `${repoSite}ImageFiles/two17.bmp`, `${repoSite}ImageFiles/two18.bmp`, `${repoSite}ImageFiles/two19.bmp`, `${repoSite}ImageFiles/two20.bmp`, `${repoSite}ImageFiles/two21.bmp`, `${repoSite}ImageFiles/two22.bmp`, `${repoSite}ImageFiles/two23.bmp`, `${repoSite}ImageFiles/two24.bmp`, `${repoSite}ImageFiles/single1.bmp`, `${repoSite}ImageFiles/single2.bmp`, `${repoSite}ImageFiles/single3.bmp`, `${repoSite}ImageFiles/single4.bmp`, `${repoSite}ImageFiles/single5.bmp`, `${repoSite}ImageFiles/single6.bmp`, `${repoSite}ImageFiles/single7.bmp`, `${repoSite}ImageFiles/single8.bmp`, `${repoSite}ImageFiles/single9.bmp`, `${repoSite}ImageFiles/single10.bmp`, `${repoSite}ImageFiles/single11.bmp`, `${repoSite}ImageFiles/single12.bmp`, `${repoSite}ImageFiles/single13.bmp`, `${repoSite}ImageFiles/single14.bmp`, `${repoSite}ImageFiles/single15.bmp`, `${repoSite}ImageFiles/single16.bmp`, `${repoSite}ImageFiles/single17.bmp`, `${repoSite}ImageFiles/single18.bmp`, `${repoSite}ImageFiles/single19.bmp`, `${repoSite}ImageFiles/single20.bmp`, `${repoSite}ImageFiles/single21.bmp`, `${repoSite}ImageFiles/single22.bmp`, `${repoSite}ImageFiles/single23.bmp`, `${repoSite}ImageFiles/single24.bmp`, `${repoSite}ImageFiles/word-two1.bmp`, `${repoSite}ImageFiles/word-two2.bmp`, `${repoSite}ImageFiles/word-two3.bmp`, `${repoSite}ImageFiles/word-two4.bmp`, `${repoSite}ImageFiles/word-two5.bmp`, `${repoSite}ImageFiles/word-two6.bmp`, `${repoSite}ImageFiles/word-two7.bmp`, `${repoSite}ImageFiles/word-two8.bmp`, `${repoSite}ImageFiles/word-two9.bmp`, `${repoSite}ImageFiles/word-two10.bmp`, `${repoSite}ImageFiles/word-two11.bmp`, `${repoSite}ImageFiles/word-two12.bmp`, `${repoSite}ImageFiles/word-two13.bmp`, `${repoSite}ImageFiles/word-two14.bmp`, `${repoSite}ImageFiles/word-two15.bmp`, `${repoSite}ImageFiles/word-two16.bmp`, `${repoSite}ImageFiles/word-two17.bmp`, `${repoSite}ImageFiles/word-two18.bmp`, `${repoSite}ImageFiles/word-two19.bmp`, `${repoSite}ImageFiles/word-two20.bmp`, `${repoSite}ImageFiles/word-two21.bmp`, `${repoSite}ImageFiles/word-two22.bmp`, `${repoSite}ImageFiles/word-two23.bmp`, `${repoSite}ImageFiles/word-two24.bmp`, `${repoSite}ImageFiles/word-single1.bmp`, `${repoSite}ImageFiles/word-single2.bmp`, `${repoSite}ImageFiles/word-single3.bmp`, `${repoSite}ImageFiles/word-single4.bmp`, `${repoSite}ImageFiles/word-single5.bmp`, `${repoSite}ImageFiles/word-single6.bmp`, `${repoSite}ImageFiles/word-single7.bmp`, `${repoSite}ImageFiles/word-single8.bmp`, `${repoSite}ImageFiles/word-single9.bmp`, `${repoSite}ImageFiles/word-single10.bmp`, `${repoSite}ImageFiles/word-single11.bmp`, `${repoSite}ImageFiles/word-single12.bmp`, `${repoSite}ImageFiles/word-single13.bmp`, `${repoSite}ImageFiles/word-single14.bmp`, `${repoSite}ImageFiles/word-single15.bmp`, `${repoSite}ImageFiles/word-single16.bmp`, `${repoSite}ImageFiles/word-single17.bmp`, `${repoSite}ImageFiles/word-single18.bmp`, `${repoSite}ImageFiles/word-single19.bmp`, `${repoSite}ImageFiles/word-single20.bmp`, `${repoSite}ImageFiles/word-single21.bmp`, `${repoSite}ImageFiles/word-single22.bmp`, `${repoSite}ImageFiles/word-single23.bmp`, `${repoSite}ImageFiles/word-single24.bmp`];
